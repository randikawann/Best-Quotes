...
//    OtherViewActivity otherViewActivity;
    int quoteimage[];

    public QuotesAdapter(Context context, List<Quote> quotelist,  int quoteimage[]){
        this.context = context;
        this.quotelist = quotelist;
    }

    public QuotesAdapter(Context context, int[] quoteimage) {
        this.context = context;
